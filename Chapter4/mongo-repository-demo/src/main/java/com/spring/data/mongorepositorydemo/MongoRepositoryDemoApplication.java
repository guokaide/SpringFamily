package com.spring.data.mongorepositorydemo;

import com.spring.data.mongorepositorydemo.converter.MoneyReadConverter;
import com.spring.data.mongorepositorydemo.model.Coffee;
import com.spring.data.mongorepositorydemo.repository.CoffeeRepository;
...
public class MongoRepositoryDemoApplication implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        coffeeRepository.findByName("lattee").forEach(coffee -> log.info("Coffee {}", coffee));
