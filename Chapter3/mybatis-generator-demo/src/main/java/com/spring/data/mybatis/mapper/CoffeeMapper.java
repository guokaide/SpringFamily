...
public interface CoffeeMapper {
     ...
     *
     * @mbg.generated Fri Mar 22 11:20:46 CST 2019
     */
    ...
    @Insert({
        ...
        "values (#{name,jdbcType=VARCHAR}, #{price,jdbcType=BIGINT,typeHandler=com.spring.data.mybatis.handler.MoneyTypeHandler}, ",
    ...
    @ResultMap("com.spring.data.mybatis.mapper.CoffeeMapper.BaseResultMap")
    ...
    @Update({
        ...
        "set NAME = #{name,jdbcType=VARCHAR},",
          "PRICE = #{price,jdbcType=BIGINT,typeHandler=com.spring.data.mybatis.handler.MoneyTypeHandler},",
